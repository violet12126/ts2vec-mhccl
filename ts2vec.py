...
class TS2Vec:
    ...
    def fit(self, train_data, n_epochs=None, n_iters=None, verbose=False,after_epoch_callback=None):
        ...
        while True:
            ...
            # 优先使用传入的回调
            current_callback = after_epoch_callback or self.after_epoch_callback
            if current_callback is not None:
                current_callback(self, cum_loss)
